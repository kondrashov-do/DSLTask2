...
public class RoboRoute extends JFrame {
  ...
  private int boundaryMinX = 0;
  private int boundaryMinY = 0;
  private int boundaryMaxX = 400;
  private int boundaryMaxY = 0;

  private JPanel panel = new JPanel() {
    @Override
    protected void paintComponent(Graphics graphics) {
      super.paintComponent(graphics);
      Point currentStartPoint = new Point(12, 12);
