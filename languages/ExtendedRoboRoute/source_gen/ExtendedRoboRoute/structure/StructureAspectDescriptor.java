...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForRefToVar() {
    return new ConceptDescriptorBuilder("ExtendedRoboRoute.structure.RefToVar", MetaIdFactory.conceptId(0x5932703a14ff46bdL, 0xa9cfc081255d1355L, 0x21447d0d74850156L)).super_("jetbrains.mps.baseLanguage.structure.Expression").version(1).super_(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).parents("jetbrains.mps.baseLanguage.structure.Expression").parentIds(MetaIdFactory.conceptId(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL)).referenceDescriptors(new ConceptDescriptorBuilder.Ref(0x21447d0d748501f6L, "var", MetaIdFactory.conceptId(0x5932703a14ff46bdL, 0xa9cfc081255d1355L, 0x21447d0d7447cdafL), false, new SNodePointer("r:49156d61-fa18-43e6-b5b6-cb7e06493b7b(ExtendedRoboRoute.structure)", "2397178398410867190"))).references("var").sourceNode(new SNodePointer("r:49156d61-fa18-43e6-b5b6-cb7e06493b7b(ExtendedRoboRoute.structure)", "2397178398410867030")).create();
  }
